...
public class Funciones {
	...
	public static int esMayorQue (LocalDate fecha, LocalDate fechaAComparar) {
		return fecha.compareTo(fechaAComparar);
	}
	
	public static boolean estaEnRango(LocalDate fecha, LocalDate fFin, LocalDate FInicio) {
		
		return ((fecha.isBefore(FInicio)||	fecha.equals(FInicio))&&(fecha.isAfter(fFin)||fecha.equals(fFin)));
	}
